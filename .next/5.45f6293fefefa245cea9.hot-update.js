        ...
        value: function listRender() {
            var items = this.state.all.map(function (all) {
                return {
                    ...
                    extra: __WEBPACK_IMPORTED_MODULE_5__ethereum_web3__["a" /* default */].utils.toEther(all.worth.toString(), 'wei') + ' ETH'
...
//# sourceMappingURL=5.45f6293fefefa245cea9.hot-update.js.map