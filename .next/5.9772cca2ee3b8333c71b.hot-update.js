        ...
        _createClass(LoverAll, [{
                ...
                value: function () {
                        var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(props) {
                                var Lover, loverList, amountOfLovers, loverObj, i;
                                        ...
                                        while (1) {
                                                switch (_context.prev = _context.next) {
                                                        ...
                                                        case 4:
                                                                ...
                                                                console.log({ amountOfLovers: amountOfLovers });
                                                                _context.next = 8;
                                                                return __WEBPACK_IMPORTED_MODULE_4__ethereum_lover__["a" /* default */].methods.loverList(1).call();

                                                        case 8:
                                                                loverObj = _context.sent;

                                                                console.log({ loverObj: loverObj });
                                                                i = void 0;
                                                                // for (i = 0; i < amountOfLovers; i++) {
                                                                //     const lover = await lover.methods.loverList(i).call();
                                                                //     console.log(lover);
...
//# sourceMappingURL=5.9772cca2ee3b8333c71b.hot-update.js.map