...
var stringShapeRegex = /[0-9\.-]+/g; // Covers rgb, rgba, hsl, hsla
...
function (_React$PureComponent) {
  ...
  _proto.updateProps = function updateProps(props, force) {
    ...
    this.animations = allProps.reduce(function (acc, _ref, i) {
      ...
      entry.start = function (cb) {
        ...
        if (hold && (hold === true || hold.indexOf(name) !== -1)) return onFinish();
        controller(entry.animation, _objectSpread({
          to: toValue
        }, config), impl).start(function (props) {
          return props.finished && onFinish();
        });
      };
  ...
  _proto.render = function render() {
    ...
    if (values && Object.keys(values).length) {
      var animatedProps = _objectSpread({}, values, this.getForwardProps());
